package wenping.catloadinglibrary;
...
/**
 * 逐步将 EditText 中的文字通过动画展示出来
 * note : ValueAnimator 要求 Android API 11
 */
public class GraduallyTextView extends EditText {
    ...
    public void init() {
        ...
        setBackground(null);   // requires API 16
       // setBackgroundDrawable(null); //过时
    ...
    public void setSigleDuration(float duration){
        this.sigleDuration = duration;
    }
    ...
    protected void onVisibilityChanged(View changedView, int visibility) {
        ...
        if (visibility == View.VISIBLE) {
            valueAnimator.resume(); // requires API 19
        }
        else {
            valueAnimator.pause();  // requires API 19
        }
    }
